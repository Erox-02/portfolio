      ...
      <div className="container-custom text-center">
        ...
        <div className="text-text-secondary text-xl md:text-2xl font-mono mb-8 max-w-2xl mx-auto">
          {prefersReducedMotion ? (
            <span>Tuning kernels, optimizing systems, and always down to cool collabs—ping my Discord or IG.</span>
          ) : (
            <TypewriterText 
              text="Tuning kernels, optimizing systems, and always down to cool collabs—ping my Discord or IG." 
              delay={60} 
